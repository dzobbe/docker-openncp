				...
				<table width="100%">
					...
					<tr>
						...
						<td width="40%">
							<xsl:choose>
								<xsl:when
									test="/n1:ClinicalDocument/n1:responsibleParty/n1:assignedEntity/n1:assignedPerson/n1:name">
									<xsl:call-template name="getName">
										<xsl:with-param name="name"
	...
	<xsl:template match="n1:renderMultiMedia">
		...
		<xsl:choose>
			<xsl:when test="//n1:regionOfInterest[@ID=$imageRef]">
				...
				<xsl:if
					test="//n1:regionOfInterest[@ID=$imageRef]//n1:observationMedia/n1:value[@mediaType="
					image / gif " or @ mediaType="image/jpeg" ]>
					<br clear="all" />
...
<xsl:value-of
			...
			<xsl:otherwise>
				...
				<xsl:if test="//n1:observationMedia[@ID=$imageRef]/n1:value[@mediaType="
					image / gif " or @ mediaType="image/jpeg" ]>
					<br clear="all" />
					<xsl:element name="img">
						<xsl:attribute name="src">
