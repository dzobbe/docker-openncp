...
mysql -h 10.5.0.9 -P 3307 -u root -pkonfido < init.sql


mysql -h 10.5.0.9 -P 3307 -u root -pkonfido < openncp-props-es/smp.sql
...
cd ../eadc
mysql -h 10.5.0.9 -P 3307 -u root -pkonfido eadc < CREATE_EADC.sql
